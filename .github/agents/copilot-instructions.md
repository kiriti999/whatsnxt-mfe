...
- TypeScript 5.8.2 / Node.js >=18 + Next.js 16.0.7, React 19.1.0, Mantine 8.3.10, TanStack Query 5.51.5, Redux Toolkit 2.8.2 (002-reusable-sections)
- TypeScript 5.8.2, Node.js 18+ + Next.js 16.0.7, React 19.1.0, Mantine UI 8.3.10, xior (HTTP client), @dnd-kit (drag-and-drop) (002-reusable-sections)
- MongoDB via external BFF API (baseURL: process.env.NEXT_PUBLIC_BFF_HOST || 'http://localhost:4444') (002-reusable-sections)
...
## Recent Changes
- 002-reusable-sections: Added TypeScript 5.8.2, Node.js 18+ + Next.js 16.0.7, React 19.1.0, Mantine UI 8.3.10, xior (HTTP client), @dnd-kit (drag-and-drop)
- 002-reusable-sections: Added TypeScript 5.8.2 / Node.js >=18 + Next.js 16.0.7, React 19.1.0, Mantine 8.3.10, TanStack Query 5.51.5, Redux Toolkit 2.8.2
