...
import QuestionEditor from '../../apps/web/components/QuestionEditor';
...
describe('QuestionEditor', () => {
  ...
  it('should render and save a text question', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Question Text'), { target: { value: 'What is your name?' } });
  ...
  it('should render and save a multiple choice question', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Question Type'), { target: { value: 'Multiple Choice' } });
    await waitFor(() => expect(screen.getByLabelText('Question Type')).toHaveValue('Multiple Choice'));


    fireEvent.change(screen.getByLabelText('Question Text'), { target: { value: 'Which color is blue?' } });
    ...
    fireEvent.change(screen.getByLabelText('Correct Answer (Enter exact option text)'), { target: { value: 'Blue' } });
    fireEvent.click(screen.getByText('Save Question'));
