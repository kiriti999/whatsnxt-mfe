...
export const TrainerAPI = {
    courseHistory: async function (page = null, id = null, search = null) {
        ...
        const response = await bffApiClient.get(url);
        return response;
    },
    ...
    getCourseNames: async function () {
        const response = await bffApiClient.get('/courses/trainer/get-course-names');
        return response;
    },
    ...
    getTrainers: async function () {
        const response = await bffApiClient.get('/courses/trainer/trainers');
        return response;
    },
    ...
    hireTrainer: async function (payload) {
        const response = await bffApiClient.post('/courses/trainer/hire-trainer', payload);
        return response;
    },
    updateBooking: async function (payload) {
        const response = await bffApiClient.post('/courses/trainer/update-booking', payload);
        return response;
    },
    getBooking: async function () {
        const response = await bffApiClient.get('/courses/trainer/get-bookings');
        return response;
    },
    checkout: async function (payload) {
        const response = await bffApiClient.post('/courses/trainer/checkout', payload);
        return response;
    },
};