...
const sanitizeOptions = {
  allowedTags: [
    ...
    'img', 'iframe', 'details', 'summary', 'hr', 'span', 'figure', 'figcaption',
    // Allow inline SVG diagrams (AI-generated and Excalidraw)
    'svg', 'g', 'path', 'rect', 'circle', 'ellipse', 'polygon', 'polyline', 'line',
    'text', 'tspan', 'defs', 'marker', 'mask', 'clippath', 'use', 'pattern',
  ...
  allowedAttributes: {
    ...
    div: ['class', 'style'],
    span: ['class', 'style', 'data-lexical-excalidraw-json'],
    p: ['class', 'style'],
    h1: ['class', 'style', 'id'],
    h2: ['class', 'style', 'id'],
    h3: ['class', 'style', 'id'],
    ...
    // SVG allowlist — broad enough for Excalidraw + AI-generated diagrams
    // Note: sanitize-html lowercases attribute names during HTML parsing (e.g. viewBox -> viewbox)
    svg: ['xmlns', 'version', 'viewBox', 'viewbox', 'width', 'height', 'style', 'class', 'filter'],
    g: ['transform', 'class', 'style', 'fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'opacity', 'clip-path', 'mask'],
    rect: ['x', 'y', 'width', 'height', 'rx', 'ry', 'fill', 'stroke', 'stroke-width', 'transform', 'style', 'opacity'],
    circle: ['cx', 'cy', 'r', 'fill', 'stroke', 'stroke-width', 'transform', 'style', 'opacity'],
    ellipse: ['cx', 'cy', 'rx', 'ry', 'fill', 'stroke', 'stroke-width', 'transform', 'style', 'opacity'],
    polygon: ['points', 'fill', 'stroke', 'stroke-width', 'transform', 'style', 'opacity'],
    polyline: ['points', 'fill', 'stroke', 'stroke-width', 'transform', 'style', 'opacity'],
    line: ['x1', 'y1', 'x2', 'y2', 'stroke', 'stroke-width', 'transform', 'style', 'opacity'],
    path: ['d', 'fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'stroke-dasharray', 'marker-end', 'marker-start', 'transform', 'style', 'opacity', 'fill-rule', 'clip-rule'],
    text: ['x', 'y', 'dx', 'dy', 'fill', 'font-size', 'font-weight', 'font-family', 'text-anchor', 'dominant-baseline', 'transform', 'style', 'opacity'],
    tspan: ['x', 'y', 'dx', 'dy', 'fill', 'font-size', 'font-weight', 'font-family', 'text-anchor', 'dominant-baseline', 'style'],
    defs: ['id'],
    mask: ['id', 'style', 'x', 'y', 'width', 'height', 'maskUnits', 'maskunits'],
    clippath: ['id', 'style'],
    use: ['href', 'x', 'y', 'width', 'height', 'style'],
    pattern: ['id', 'x', 'y', 'width', 'height', 'patternUnits', 'patternunits', 'style'],
    lineargradient: ['id', 'x1', 'y1', 'x2', 'y2', 'gradientUnits', 'gradientunits', 'gradientTransform', 'gradienttransform'],
    radialgradient: ['id', 'cx', 'cy', 'r', 'fx', 'fy', 'gradientUnits', 'gradientunits', 'gradientTransform', 'gradienttransform'],
    stop: ['offset', 'stop-color', 'stop-opacity', 'style'],
    figure: ['class', 'style', 'data-lexical-inline-svg'],
