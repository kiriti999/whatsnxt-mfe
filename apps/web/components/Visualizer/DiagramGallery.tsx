...
const TYPE_LABELS: Record<string, { label: string; color: string }> = {
	...
	"cheat-sheet": { label: "Cheat Sheet", color: "#ef4444" },
	timeline: { label: "Timeline", color: "#6366f1" },
	"mind-map": { label: "Mind Map", color: "#10b981" },
	"matrix-table": { label: "Matrix", color: "#64748b" },
	"decision-tree": { label: "Decision Tree", color: "#11998e" },
	"hierarchy-chart": { label: "Hierarchy", color: "#a044ff" },
	"sequence-diagram": { label: "Sequence", color: "#f472b6" },
	"kanban-board": { label: "Kanban", color: "#f59e0b" },
	"swot-analysis": { label: "SWOT", color: "#e44d26" },
	"network-topology": { label: "Network", color: "#2193b0" },
	"hub-spoke-reference": { label: "Hub & spoke", color: "#0ea5e9" },
	"vertical-layer-stack": { label: "Layers", color: "#22c55e" },
	"microservices-field-guide": { label: "MS field guide", color: "#64748b" },
	"radial-domain-map": { label: "Radial map", color: "#f472b6" },
	"sectioned-playbook": { label: "Playbook", color: "#f59e0b" },
	"parallel-pipelines": { label: "Pipelines", color: "#ca8a04" },
	"tier-list-ranking": { label: "Tier list", color: "#dc2626" },
	"poster-blueprint": { label: "Poster", color: "#2563eb" },
	"numbered-pattern-sheet": { label: "Patterns #", color: "#334155" },
};
								...
								return (
									...
									>
										...
										>
											...
											>
												{(() => {
													const Renderer = getRenderer(diagram.diagramType);
													return (
														<Renderer
				...
				>
					<Stack>
						...
						<Group justify="flex-end" gap="sm">
							<Button variant="subtle" onClick={() => setDeleteModal(null)}>
								Cancel
							</Button>
