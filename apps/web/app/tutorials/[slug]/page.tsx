    ...
    useEffect(() => {
        ...
        const resolveParams = async () => {
            ...
            try {
                ...
                const firstSectionWithPosts = tree.sections.find(
                    (s) => s.posts && s.posts.length > 0,
                );
                ...
                if (firstSectionWithPosts && firstSectionWithPosts.posts.length > 0) {
                    ...
                    router.replace(
                        `/content/${firstPost.slug}?tutorial=${tutorial.slug}&section=${firstSectionWithPosts.slug}`,
                    );
                } else {
