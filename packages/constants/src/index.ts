...
export const API_ENDPOINTS = {
	...
	LAB_PAGE_BY_ID: (labId: string, pageId: string) =>
...
export const ROUTE_PATHS = {
	...
	LAB_PAGE_EDITOR: (labId: string, pageId: string) =>
...
export const PAGINATION = {
	...
	/** /labs published grid page size */
	LAB_DIRECTORY_PAGE_SIZE: 12,
} as const;
...
export const ERROR_MESSAGES = {
	...
	LAB_CREATION_FAILED:
		"Failed to create lab and default page. Please try again.",
	...
	AT_LEAST_ONE_TEST_REQUIRED:
		"At least one test (question or diagram) is required",
...
export const SUCCESS_MESSAGES = {
	...
	LAB_CREATED_REDIRECTING:
		"Lab created successfully! Redirecting to page editor...",
