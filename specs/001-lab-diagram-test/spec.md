...
-   **FR-002**: Each page/step MUST allow the instructor to add either a standard question (MCQ, text) or a diagram test.
...
-   **Lab**: Represents a learning module, contains one or more pages.
-   **LabPage**: A step or a page within a lab. Can contain either a question or a diagram test.
